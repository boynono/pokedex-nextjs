...
export async function getServerSideProps(ctx) {
  ...
  function getPokemonInfo() {
    return axios.get(baseUrl + `/api/v2/pokemon/${id}`);
  }

  function getPokemonSpecies() {
    return axios.get(`/api/v2/pokemon-species/${id}`);
  }

  Promise.all([getPokemonInfo(), getPokemonSpecies()]).then(function (results) {
